...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-file-invoice"></i> Receiving Reports</h1>



    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Receiving Reports</h6>
        </div>
        <div class="card-body">
                ...
                <form method="POST" action="{{ route('reports.receiving.generate') }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-bordered" id="productTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                @forelse ($receivingLogs as $log)
                                    <tr>
                                        <td>{{ ($receivingLogs->currentPage() - 1) * $receivingLogs->perPage() + $loop->iteration }}.</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center">No receiving transactions available</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-2">
                                        ...
                                        <div class="table">
                                            <p class="mb-0">
                                                Showing {{ $receivingLogs->firstItem() }} to {{ $receivingLogs->lastItem() }} of {{ $receivingLogs->total() }} entries
                                            </p>
                                        </div>
