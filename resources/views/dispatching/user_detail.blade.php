    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3">
                <a href="{{ route('dispatching.user_header') }}" class="btn btn-secondary">Back to List</a>
    ...
    <div class="modal fade" id="addDispatchingDetailModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <!-- Modal body -->
                    <form action="{{ route('dispatching.user_detail.UserAddDetail') }}" method="POST" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="confirmAllForm" method="POST" action="{{ route('dispatching.UserConfirmAll', $dispatchingHeader->dispatching_header_id) }}">
                        @csrf
                        @method('PUT')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.btn-edit').on('click', function() {
                ...
                $.ajax({
                    url: `/user/dispatching/detail-modal/${detailId}`, // URL rute Laravel
                    method: 'GET',
                    success: function(data) {
                        ...
                        if (productId) {
                            $.ajax({
                                url: `/user/products/${productId}/unit`, // Endpoint untuk mendapatkan unit
                                method: 'GET',
            ...
            $('.btn-show').on('click', function() {
                ...
                // Lakukan permintaan AJAX ke server
                $.ajax({
                    url: `/user/products/detail/${productId}`, // URL rute Laravel
                    method: 'GET',
                    success: function(data) {
            ...
            $('.btn-delete').on('click', function() {
                ...
                const deleteUrl = `/user/dispatching/detail/${detailId}`;
            ...
            $('.btn-confirm').on('click', function() {
                ...
                const confirmUrl = `/user/dispatching/detail/confirm/${detailId}`;
            ...
            // DISPATCHING QTY LIMITER FOR ADD MODAL
                $('#product_id').on('change', function() {
                    ...
                    if (productId) {
                        // Lakukan permintaan AJAX ke server
                        $.ajax({
                            url: `/user/products/${productId}/qty`, // Endpoint untuk mendapatkan product_qty
                            method: 'GET',
                            success: function(response) {
