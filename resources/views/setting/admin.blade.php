                        ...
                        <div class="card-body">
                            <div class="e-profile">
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a href="#myProfile" class="active nav-link" data-toggle="tab">My Profile</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#companyProfile" class="nav-link" data-toggle="tab">Company Profile</a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <form action="{{ route('setting.admin.updateCompany') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3 text-center mb-3">
                                                <img id="CompanyLogo" src="{{ $usercompany->company_img ? asset('storage/' . $usercompany->company_img) : asset('img/default-company-logo.png') }}" alt="Company Logo" class="img-fluid rounded" style="max-height: 310px;">
                                                <div class="mt-3">
                                                    <label for="company_img" class="btn btn-primary btn-sm">
                                                        <i class="fas fa-upload"></i> Change Logo
                                                    </label>
                                                    <input type="file" id="company_img" name="company_img" class="d-none">
                                                </div>
                                            </div>
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="company_description" name="company_description" rows="4">{{ $usercompany->company_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
