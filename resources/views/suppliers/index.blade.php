                ...
                <form action="{{ route('suppliers.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('supplier_website') is-invalid @enderror" id="supplier_website" name="supplier_website" value="{{ old('supplier_website') }}" placeholder="Enter supplier website" required>
                ...
                <form id="editSupplierForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="editSupplierWebsite" name="supplier_website" required>
                        </div>
                    </div>
